...
* To make a fair comparison for LASSO, I fixed alpha = 1 in caret and tuned only lambda. Under this setting, caret selected lambda = 40.405, which is close to `glmnet`’s 38.517.  
